    ...
    <div>
        <div class="subheader subheader-margin-top d-flex">
            ...
            <v-menu offset-y class="rounded-lg">
                <template v-slot:activator="{ on, attrs }">
                    <v-btn class="calendar-button" color="foreground" rounded depressed v-bind="attrs" v-on="on">
                        <span id="goal-selection-text-small">{{ $t('goals.goal') }}</span>
                        <span id="goal-selection-text">{{ $t('goals.displayedGoal') }}</span>
                        <v-icon v-if="attrs['aria-expanded'] === 'true' ">mdi-chevron-up</v-icon>
                        <v-icon v-if="attrs['aria-expanded'] !== 'true'">mdi-chevron-down</v-icon>
                    </v-btn>
                </template>
                <v-btn  class="menu-button justife-start" tile color="white" @click="selectedGoal = 'reviews_due'; updateCalendar();">{{ $t('goals.reviewsDue') }}</v-btn>
                <v-btn  class="menu-button justife-start" tile color="white" @click="selectedGoal = 'read_words'; updateCalendar();">{{ $t('goals.reading') }}</v-btn>
                <v-btn  class="menu-button justife-start" tile color="white" @click="selectedGoal = 'review'; updateCalendar();">{{ $t('goals.review') }}</v-btn>
                <v-btn  class="menu-button justife-start" tile color="white" @click="selectedGoal = 'learn_words'; updateCalendar();">{{ $t('goals.newWords') }}</v-btn>
            </v-menu>
            ...
            >
                ...
                >
                    <v-spacer></v-spacer>
                    <v-btn text rounded @click="showDatePicker = false">{{ $t('common.close') }}</v-btn>
                </v-date-picker>
            </v-menu>
        </div>
                            ...
                            <v-simple-table dense class="no-row-border no-hover">
                                <tbody>
                                    ...
                                    <tr v-for="(achievement, index) in popupMenu.achievements" :key="index">
                                        ...
                                        <td v-if="!achievement.goalQuantity">{{ $t('common.none') }}</td>
                                    </tr>
                                </tbody>
                            </v-simple-table>
                        </v-tab-item>
    ...
    export default {
        data: function() {
            return {
                ...
                reviewsDue: [],
                goalTexts: {
                    'review': this.$t('goals.review').toLowerCase(),
                    'read_words': this.$t('goals.reading').toLowerCase(),
                    'learn_words': this.$t('goals.newWords').toLowerCase(),
                },
