<template>
    <v-dialog v-model="value" persistent max-width="300px">
            <v-card class="rounded-lg">
                <v-card-title>
                    <span class="text-h5">{{ $t('dialogs.themeTitle') }}</span>
                    <v-spacer></v-spacer>
    ...
    export default {
        ...
        data: function() {
            return {
                ...
                displayNames: {
                    auto: {
                        name: this.$t('dialogs.themeAuto'),
                        icon: 'mdi-theme-light-dark'
                    },
                    light: {
                        name: this.$t('dialogs.themeLight'),
                        icon: 'mdi-weather-sunny'
                    },
                    dark: {
                        name: this.$t('dialogs.themeDark'),
                        icon: 'mdi-weather-night'
                    },
                    eink: {
                        name: this.$t('dialogs.themeEink'),
                        icon: 'mdi-tablet'
                    }
                },
            };
